package com.daday.finalgithubuser.utils
...
import com.daday.finalgithubuser.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setDailyReminder(context: Context, type: String, message: String) {
        ...
        Toast.makeText(context, R.string.alarmon, Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelAlarm(context: Context) {
        ...
        Toast.makeText(context, R.string.alarmoff, Toast.LENGTH_SHORT).show()
    }
